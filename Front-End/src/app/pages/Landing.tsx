          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">
                Consist<span className="text-emerald-505 dark:text-emerald-400">Pay</span>
              </span>
            </Link>
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link to="/signup" className="px-5 py-2.5 bg-zinc-800 dark:bg-white hover:bg-zinc-700 dark:hover:bg-zinc-200 text-white dark:text-black font-bold rounded-xl text-xs transition-all active:scale-[0.98]">
                Start Free
              </Link>
            </div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="pt-4 flex flex-col gap-3">
                    <Link 
                      to="/login" 
                      onClick={() => setMobileMenuOpen(false)}
                      className="w-full py-3 text-center text-xs font-bold text-zinc-650 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-white rounded-xl border border-zinc-200 dark:border-white/5 bg-zinc-50 dark:bg-white/[0.01] active:scale-95 transition-all"
                    >
                      Sign In
                    </Link>
                    <Link 
                      to="/signup" 
                      onClick={() => setMobileMenuOpen(false)}
                      className="w-full py-3 text-center text-xs font-bold bg-zinc-800 dark:bg-white text-white dark:text-black hover:bg-zinc-700 dark:hover:bg-zinc-200 rounded-xl active:scale-95 transition-all"
                    >
                      Start Free
                    </Link>
                  </div>
      ...
      <main className="w-full pt-[60px]">
        ...
        <div className="py-20 md:py-28 relative overflow-hidden bg-white dark:bg-[#000000] border-b border-zinc-200 dark:border-white/[0.04]">
          <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
            ...
            <p className="text-sm md:text-base text-zinc-500 dark:text-zinc-400 mb-10 max-w-xl mx-auto leading-relaxed">
              Adopt Consisty, connect your platforms, set your stakes, and start building placement-ready habits today.
            </p>
            <Link to="/signup" className="group inline-flex items-center gap-2 px-8 py-3.5 bg-zinc-800 dark:bg-white text-white dark:text-black hover:bg-zinc-700 dark:hover:bg-zinc-200 font-bold rounded-xl transition-all active:scale-98">

...
const CustomGoogleButton = ({ onSuccess, onError, loading }: { onSuccess: (tokenResponse: any) => void, onError: () => void, loading: boolean }) => {
  ...
  return (
    <button
      ...
      onClick={() => login()}
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 bg-white text-black font-semibold rounded-xl px-4 py-3.5 hover:bg-zinc-200 transition-all disabled:opacity-50"
    >

...
interface ConsistencyCalendarProps {
  ...
  yearMonths: {
    ...
    name: string;
    weeks: {
      status: "completed" | "missed" | "pending" | "empty";
      date?: Date;
    }[][];
  }[];
}
                      ...
                      >
                        ...
                        {week.map((cell, dayIdx) => (
                          <div
                            key={dayIdx}
                            className={`
                              group relative w-[13px] h-[13px] rounded-[3px]
                              transition-all duration-200 hover:scale-125 cursor-pointer
                              
                              ${
                                cell.status === "completed"
                                  ? "bg-[#10B981]/25 border border-[#10B981]/40 hover:bg-[#10B981]/40"
                                  : cell.status === "missed"
                                  ? "bg-[#EF4444]/25 border border-[#EF4444]/40 hover:bg-[#EF4444]/40"
                                  : cell.status === "pending"
                                  ? "bg-[#374151]"
                                  : "bg-transparent"
                              }
                          ...
                          >
                            ...
                            {cell.date && (
                              <div className="absolute z-50 hidden group-hover:flex flex-col pointer-events-none bottom-[18px] left-1/2 -translate-x-1/2 whitespace-nowrap bg-[#111111] border border-white/10 rounded-lg px-3 py-2 shadow-2xl">

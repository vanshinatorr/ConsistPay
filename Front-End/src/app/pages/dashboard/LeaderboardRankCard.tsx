...
export function LeaderboardRankCard({
  ...
  return (
    <div className="relative group h-full">
      ...
      <div className="relative bg-white dark:bg-[#0F0F13] border border-zinc-200 dark:border-white/[0.04] rounded-2xl p-5 hover:border-zinc-300 dark:hover:border-white/10 transition-all duration-300 flex flex-col justify-between h-[249px] min-h-[249px] shadow-xl overflow-hidden">
        ...
        <div className="flex items-center justify-between relative z-10">
          <div className="flex flex-col">
            ...
            <span className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">Global Rank</span>
          </div>
        ...
        <div className="my-4 relative z-10 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-550 dark:text-zinc-500 mt-2 font-medium">
        ...
        <button
          ...
          className="w-full py-2 bg-zinc-100 dark:bg-white/5 border border-zinc-200 dark:border-white/[0.04] rounded-xl hover:bg-zinc-200 dark:hover:bg-violet-600 hover:border-zinc-300 dark:hover:border-violet-500/30 text-zinc-700 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-white transition-all text-xs font-bold flex items-center justify-center gap-1.5 cursor-pointer relative z-10 group/btn"
        >
          View Leaderboard

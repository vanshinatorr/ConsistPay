...
export function LeaderboardRankCard({
  ...
  return (
    <div className="relative group h-full">
      ...
      <div className="relative bg-[#0F0F13] border border-white/[0.04] rounded-2xl p-5 hover:border-white/10 transition-all duration-300 flex flex-col justify-between h-full min-h-[196px] shadow-xl overflow-hidden">

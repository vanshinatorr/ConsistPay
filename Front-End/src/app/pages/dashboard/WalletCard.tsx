  ...
  return (
    <div className="relative h-full flex flex-col">
      ...
      <div className="relative bg-white dark:bg-gradient-to-b dark:from-[#141522]/95 dark:to-[#0F1018]/95 border border-zinc-200 dark:border-white/[0.12] rounded-2xl p-5 flex flex-col justify-between h-[522px] min-h-[522px] shadow-[0_20px_50px_rgba(0,0,0,0.02)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.4)] overflow-hidden hover:border-zinc-300 dark:hover:border-white/[0.18] transition-all duration-300">
        ...
        {/* ─── HEADER ─── */}
        <div className="flex items-center justify-between pb-3.5 border-b border-zinc-100 dark:border-white/[0.04] relative z-10 shrink-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1 mt-4 relative z-10 overflow-hidden">
          ...
          <div className="flex flex-col justify-between h-full">
            ...
            <div className="bg-amber-500/[0.03] dark:bg-amber-500/[0.01] border border-amber-200 dark:border-amber-500/10 rounded-xl p-4 mt-2.5 flex-1 flex flex-col justify-center hover:border-amber-400 dark:hover:border-amber-500/20 transition-all duration-200 shadow-md">
              ...
              <span className="text-2xl font-bold text-amber-600 dark:text-amber-400 tracking-tight mt-1.5 block">
          ...
          <div className="flex flex-col justify-between h-full">
            ...
            <div className={`border rounded-xl p-3 text-left flex flex-col items-start justify-center transition-all duration-300 ${
              ...
              <div className="flex items-center gap-2">
                {hasSolvedToday ? (
                  <>
                    ...
                    <span className="text-xs font-bold tracking-wider text-emerald-600 dark:text-emerald-400">Streak Protected for Today!</span>
                  </>
                ) : isStakeAtRisk ? (
                  <>
              ...
              <div className="w-full mt-3 pt-3 border-t border-zinc-150 dark:border-white/[0.04] flex items-center justify-between gap-3">
                {/* Streak Timer Status */}
                {!hasSolvedToday && hasVerifiedPlatform && timeLeft ? (
                  <div className="flex items-center gap-1 font-mono text-zinc-800 dark:text-zinc-150 shrink-0 select-none">
                    ...
                    <div className={`px-2 py-1 rounded bg-zinc-100 dark:bg-[#0A0B10]/80 border border-zinc-200 dark:border-white/[0.04] text-[11.5px] font-bold shadow-inner ${isStakeAtRisk ? "text-red-500 border-red-200 dark:border-red-500/20" : "text-zinc-700 dark:text-zinc-200"}`}>
                  ...
                  <div className="flex items-center gap-1.5 text-[10px] font-bold text-emerald-600 dark:text-emerald-450 select-none bg-emerald-500/5 px-2 py-1 rounded-lg border border-emerald-200 dark:border-emerald-500/10">
                  ...
                  <div className="shrink-0 flex-1 flex justify-end">
                    {hasVerifiedPlatform ? (
                      ...
                      <button
                        ...
                        className="h-8.5 px-3 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/20 text-amber-600 dark:text-amber-400 rounded-lg font-bold text-[10px] flex items-center justify-center transition-all cursor-pointer active:scale-95 shadow-sm"
                      >
                        Link Profile
                      </button>
                    )}
              ...
              {apiError && (
                <div className="w-full mt-2.5 pt-2.5 border-t border-zinc-150 dark:border-white/[0.03] text-left">
            ...
            <div className="grid grid-cols-2 gap-3 mt-2.5">
              ...
              <div className="bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-250 dark:border-emerald-500/20 rounded-xl p-3 flex flex-col justify-between hover:border-emerald-300 dark:hover:border-emerald-500/35 transition-all duration-200 shadow-sm">
                ...
                <span className="text-xl font-bold font-mono text-emerald-600 dark:text-emerald-400 mt-2">
                  +₹{completedDays * dailyCommitment}
                </span>
              ...
              <div className="bg-rose-50 dark:bg-rose-950/20 border border-rose-250 dark:border-rose-500/20 rounded-xl p-3 flex flex-col justify-between hover:border-rose-300 dark:hover:border-rose-500/35 transition-all duration-200 shadow-sm">
                ...
                <span className="text-xl font-bold font-mono text-rose-600 dark:text-rose-450 mt-2">

                     ...
                     <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                           <div className="flex justify-between items-center mb-1.5">
                              ...
                              <span className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Score: {myData.score} / {challengeItem.duration}</span>
                           </div>
                     ...
                     <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                           <div className="flex justify-between items-center mb-1.5">
                              ...
                              <span className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Score: {oppData.score} / {challengeItem.duration}</span>
                           </div>
                           <div className="w-full h-1 bg-zinc-150 dark:bg-zinc-800/80 rounded-full overflow-hidden">

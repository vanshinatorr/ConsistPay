      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
            How Consist<span className="text-emerald-400">Pay</span> Works
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col items-start text-left">
            <span className="text-[9px] font-bold text-emerald-400 uppercase tracking-widest block mb-2 font-mono">
            ...
            <p className="text-xs sm:text-sm text-zinc-405 leading-relaxed font-normal mb-8 max-w-lg">
              ...
              {tabs[activeTab].features.map((feature, i) => (
                <div key={i} className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20 shrink-0">
                    <Check className="w-3.5 h-3.5 text-emerald-450" strokeWidth={2.5} />
                  </div>
          ...
          <div className="relative flex items-center justify-center w-full">
            ...
            {/* Widget Container */}
            <div className="w-full max-w-md bg-[#090A0F] border border-zinc-805 rounded-[2rem] p-6 sm:p-8 shadow-2xl relative z-10 transition-all duration-300">
              
              {/* Tab 0 Widget: Commit Setup */}
              {activeTab === 0 && (
                <div className="space-y-6">
                  <div className="flex items-center justify-between pb-4 border-b border-white/[0.04]">
                    <span className="text-xs font-bold text-zinc-450">Lock Commitment</span>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-white/[0.01] border border-white/[0.03] rounded-xl flex justify-between items-center">
                      ...
                      <span className="text-[9px] font-bold text-emerald-400 px-2 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/20 uppercase tracking-wider">
                        Principal Protected
                      </span>
                    </div>
                    ...
                    <div className="space-y-2.5">
                      ...
                      <div className="flex flex-col sm:flex-row gap-2">
                        <span className="text-xs font-semibold text-zinc-300 px-3 py-1.5 bg-amber-500/5 border border-amber-500/10 rounded-lg flex items-center gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-amber-500" /> LeetCode: demouser
                        </span>
                        <span className="text-xs font-semibold text-zinc-300 px-3 py-1.5 bg-emerald-500/5 border border-emerald-500/10 rounded-lg flex items-center gap-2">
              ...
              {activeTab === 1 && (
                <div className="space-y-6">
                  <div className="flex items-center justify-between pb-4 border-b border-white/[0.04]">
                    <span className="text-xs font-bold text-zinc-450">Background Sync Engine</span>
                    <span className="text-[9px] text-emerald-400 font-semibold px-2 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/20 flex items-center gap-1.5 uppercase tracking-wider">
                      <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" /> Live API Sync
                    </span>
                  </div>
                  <div className="space-y-3.5">
                    {/* LeetCode Row */}
                    <div className="flex items-center justify-between p-3 bg-white/[0.01] border border-white/[0.03] rounded-xl">
                      <div className="flex flex-col">
                        <span className="text-xs font-semibold text-white">LeetCode API Query</span>
                        <span className="text-[10px] text-zinc-500">leetcode.com/u/demouser</span>
                      </div>
                      <div className="flex items-center gap-1.5 text-xs text-emerald-400 font-bold bg-emerald-500/10 border border-emerald-500/20 px-2 py-0.5 rounded-md">
                    ...
                    <div className="flex items-center justify-between p-3 bg-white/[0.01] border border-white/[0.03] rounded-xl">
                      <div className="flex flex-col">
                        <span className="text-xs font-semibold text-white">GFG API Query</span>
                    ...
                    <div className="flex justify-between items-center text-[10px] text-zinc-550 border-t border-white/[0.04] pt-3 px-1">
              ...
              {activeTab === 2 && (
                <div className="space-y-6">
                  <div className="flex items-center justify-between pb-4 border-b border-white/[0.04]">
                    <span className="text-xs font-bold text-zinc-450">Discipline Settlement</span>
                    <span className="text-[9px] font-bold text-emerald-400 px-2 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/20 uppercase tracking-wider">
                      Yield Active
                    </span>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="p-4 bg-emerald-500/[0.01] border border-emerald-500/10 rounded-xl">
                        <span className="text-[10px] text-emerald-500/60 uppercase tracking-wider block mb-0.5">Community Yield</span>
                        <span className="text-sm font-bold text-emerald-450">+₹60.00</span>
                      </div>
                    </div>

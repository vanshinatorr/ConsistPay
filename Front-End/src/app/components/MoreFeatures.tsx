...
export function MoreFeatures() {
  ...
  return (
    <section className="px-6 py-16 md:py-0 relative overflow-hidden w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className={`group flex flex-col bg-[#13151f]/80 backdrop-blur-xl border border-white/5 rounded-3xl p-6 hover:border-white/10 transition-all duration-500 relative overflow-hidden ${colors.glow}`}
              >
                ...
                <div className="flex items-center gap-4 mb-4 relative z-10">
                  <div className={`w-12 h-12 rounded-2xl flex items-center justify-center border border-white/5 ${colors.iconBg} shadow-inner`}>
                ...
                <ul className="space-y-3 mb-6 flex-1 relative z-10">
                  {feature.bullets.map((bullet, i) => (
                    <li key={i} className="flex items-center gap-3">
                      ...
                      <span className="text-[13px] text-slate-300 font-medium">{bullet}</span>
                    </li>
                  ))}
                </ul>

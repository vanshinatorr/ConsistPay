      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_1.1fr] gap-16 items-center">
          ...
          <div className="relative z-20 flex flex-col items-center text-center xl:items-start xl:text-left">
            ...
            {/* Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[4rem] xl:text-[4.5rem] font-extrabold mb-6 leading-[1.15] tracking-tight text-white">
              Code Every Day<br />
            ...
            {/* Subtext */}
            <p className="text-base sm:text-lg text-slate-400 mb-10 leading-relaxed max-w-lg font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <button 
                ...
                className="group px-8 py-4 bg-white hover:bg-slate-100 text-black font-bold rounded-2xl transition-all duration-200 flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)] active:scale-95"
              >
                Start Free
              ...
              <a 
                ...
                className="group px-8 py-4 bg-white/5 hover:bg-white/10 text-white font-semibold rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-200 flex items-center justify-center gap-2 active:scale-95"
              >
                Watch Demo
            ...
            <div className="relative bg-[#0d1017] rounded-[2rem] p-4 sm:p-8 border border-slate-800 shadow-2xl">
              ...
              <div className="flex items-center justify-between mb-8 pb-6 border-b border-white/5">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-violet-500/10 rounded-2xl border border-violet-500/20 flex items-center justify-center shadow-inner">
                    <Calendar className="w-5.5 h-5.5 text-violet-400" />
                  </div>
                  <h3 className="font-black text-white text-lg sm:text-xl tracking-wide">Today's Proof</h3>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-emerald-500/10 text-emerald-400 text-xs sm:text-sm font-bold border border-emerald-500/20 shadow-[0_0_15px_rgba(16,185,129,0.15)]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
                ...
                {/* Step 1: Upload Proof */}
                <div className="bg-[#13161f] border border-white/5 rounded-3xl p-5 flex flex-col hover:border-violet-500/30 transition-colors shadow-lg min-h-[220px] sm:min-h-[240px]">
                ...
                <div className="bg-[#13161f] border border-white/5 rounded-3xl p-5 flex flex-col hover:border-violet-500/30 transition-colors relative overflow-hidden group shadow-lg min-h-[220px] sm:min-h-[240px]">
                ...
                <div className="bg-[#13161f] border border-white/5 rounded-3xl p-5 flex flex-col hover:border-violet-500/30 transition-colors relative overflow-hidden shadow-lg min-h-[220px] sm:min-h-[240px]">
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center relative z-10">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-[1.5rem] bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mb-5 shadow-[0_0_40px_rgba(16,185,129,0.2)] group-hover:scale-110 transition-transform">
              ...
              <div className="mb-8 mt-6">
                <div className="flex items-center mb-5">
                  <h4 className="text-sm font-black text-slate-350 tracking-wide uppercase">Recent Activity</h4>
                </div>
              ...
              {/* Stats Footer */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 bg-[#13161f] border border-white/5 rounded-[1.5rem] sm:rounded-[2rem] p-4 sm:p-6 shadow-lg">
                <div className="flex flex-col">
                  <span className="text-[10px] text-slate-400 mb-1.5 font-medium uppercase tracking-wider">Earned</span>
                  <div className="flex items-center gap-2">
                    <span className="text-base sm:text-lg font-bold text-white tracking-tight">₹450</span>
                  </div>
                </div>
                <div className="flex flex-col sm:border-l sm:border-white/5 sm:pl-3">
                  <span className="text-[10px] text-slate-400 mb-1.5 font-medium uppercase tracking-wider">Active</span>
                  <div className="flex items-center gap-2">
                    <span className="text-base sm:text-lg font-bold text-white tracking-tight">2</span>
                  </div>
                </div>
                <div className="flex flex-col border-t border-white/5 pt-3 sm:border-t-0 sm:pt-0 sm:border-l sm:border-white/5 sm:pl-3">
                  <span className="text-[10px] text-slate-400 mb-1.5 font-medium uppercase tracking-wider">Balance</span>
                  <div className="flex items-center gap-2">
                    <span className="text-base sm:text-lg font-bold text-white tracking-tight">₹150</span>
                  </div>
                </div>
                <div className="flex flex-col border-t border-white/5 pt-3 sm:border-t-0 sm:pt-0 sm:border-l sm:border-white/5 sm:pl-3">
                  <span className="text-[10px] text-slate-400 mb-1.5 font-medium uppercase tracking-wider">Grace</span>
                  <div className="flex items-center gap-2">
                    <span className="text-base sm:text-lg font-bold text-white tracking-tight">1</span>
                  </div>
                </div>
              </div>

      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_1.1fr] gap-16 items-center">
          ...
          <div className="relative z-20 flex flex-col items-center text-center xl:items-start xl:text-left">
            ...
            {/* Subtext */}
            <p className="text-base sm:text-lg text-zinc-300 mb-10 leading-relaxed max-w-lg font-normal">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <button 
                ...
                className="group px-7 py-3.5 bg-white hover:bg-zinc-200 text-black font-semibold rounded-xl transition-all duration-250 flex items-center justify-center gap-2 active:scale-[0.98] cursor-pointer"
              >
                Start Free
          ...
          <div className="hidden xl:block relative w-full mx-auto xl:mx-0 font-sans z-10">
            ...
            <div className="relative bg-[#090A0F] rounded-[2.5rem] p-8 border border-white/[0.05] shadow-2xl overflow-hidden">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center justify-between p-4 bg-white/[0.01] border border-white/[0.04] rounded-2xl hover:border-white/[0.08] transition-colors">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-[10px] font-bold text-emerald-400 px-2 py-0.5 rounded-md bg-emerald-500/10 border border-emerald-500/20 uppercase tracking-wider">
                      Synced
                    </span>
                    <span className="text-xs text-zinc-300 font-semibold">352 Solved</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-white/[0.01] border border-white/[0.04] rounded-2xl hover:border-white/[0.08] transition-colors">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-zinc-300 font-semibold">198 Solved</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-white/[0.005] border border-white/[0.02] border-dashed rounded-2xl opacity-40">
                  ...
                  <span className="text-[9px] font-bold text-zinc-550 border border-zinc-800 bg-[#0E0F14] px-2 py-1 rounded-md uppercase tracking-wider">
                    Coming Soon
                  </span>
                </div>
              ...
              {/* Real-time Verification Terminal Feed (High Fidelity Utility) */}
              <div className="bg-[#000000] border border-white/[0.04] rounded-2xl p-4 mb-6 font-mono text-[11px] leading-relaxed select-none">
                <div className="flex items-center justify-between text-zinc-550 mb-3 pb-2 border-b border-white/[0.03]">
                  <span className="uppercase text-[9px] font-bold tracking-wider flex items-center gap-1.5">
                    <Terminal className="w-3.5 h-3.5" /> Verification Logs
                  </span>
                ...
                <div className="space-y-1.5 text-zinc-400">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-amber-500 font-semibold">LeetCode</span>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white/[0.01] border border-white/[0.04] hover:border-white/[0.08] rounded-2xl p-4 flex items-center gap-4 transition-colors">
                ...
                <div className="bg-emerald-500/[0.01] border border-emerald-500/10 hover:border-emerald-500/20 rounded-2xl p-4 flex items-center gap-4 transition-colors">
                  <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center shrink-0">
                    <TrendingUp className="w-5 h-5 text-emerald-400" />
                  </div>
                  <div>
                    <span className="text-[9px] text-emerald-500/60 uppercase tracking-wider block mb-0.5">Shared Pool Yield</span>
                    <span className="text-sm font-bold text-emerald-400">+₹48.50 Earned</span>
                  </div>
                </div>

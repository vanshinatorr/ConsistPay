            ...
            <div className="space-y-6 animate-in fade-in duration-500">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                >
                  ...
                  <p className="text-xs text-zinc-400 mt-1 leading-relaxed">
                    Unlocks consistency battles (challenges), AI placement recommendations, 1 initial grace coin + 1 unlocks at 15-day streak, priority verification, and detailed analytics.
                  </p>
            ...
            <div className="space-y-6 animate-in fade-in duration-500">
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 rounded-xl bg-amber-500/[0.03] border border-amber-500/10 space-y-1.5 text-xs text-amber-300">
                  ...
                  <p>• Note: Grace coins cannot be used during Friend Challenges.</p>
                </div>
              </div>

...
export default function TopupModal({ onClose, onSuccess }: TopupModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start md:items-center justify-center p-4 overflow-y-auto py-8">
      ...
      <div className="relative my-auto w-full max-w-md bg-[#0D0D0F] border border-white/10 rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
